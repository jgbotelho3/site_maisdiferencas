...
import SidebarMenu from './partials/SidebarMenu.vue';
    ...
    function handleSubmit(){
        form.post(`/dashboard/categories/edit/${this.category.id}`, form)
    }
    defineProps({ category: Object, errors: Object })
